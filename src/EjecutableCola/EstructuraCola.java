...
public class EstructuraCola extends JFrame{
	
	private PanelIngreso1 pnlIngreso1;
	private PanelOpciones1 pnlOpciones1;
	private PanelInfo1 pnlInfo1;
	
	 Controlador1 ctrl1;

	public EstructuraCola(Controlador1 ctrl1)
	{
		...
		//Instaciar los paneles
		 pnlIngreso1 = new PanelIngreso1(ctrl1);
		 pnlOpciones1 = new PanelOpciones1(ctrl1);
		 pnlInfo1 = new PanelInfo1();
		 
		 getContentPane( ).add( pnlIngreso1 );
	     pnlIngreso1.setBounds( 10, 10, 230, 225 );
	     
	     getContentPane( ).add( pnlInfo1 );
	     pnlInfo1.setBounds( 255, 10, 230, 225 );
	     
	     getContentPane( ).add( pnlOpciones1 );
	     pnlOpciones1.setBounds( 10, 245, 475, 100 );
	     
	  // Conecta objetos a controlar
		  ctrl1.conectar1(pnlInfo1,pnlIngreso1);
		 
	}
		
	public class PanelIngreso1 extends JPanel
	{
		...
		public PanelIngreso1(Controlador1 ctrl1)
		{
	...
	public class PanelOpciones1 extends JPanel implements ActionListener
	{
		...
		private Controlador1 ctrl1;

		public PanelOpciones1(Controlador1 ctrl1)
		{
			setBorder(BorderFactory.createLineBorder(Color.RED.darker().darker()));
			setBackground(new Color(254,128,129));
			setLayout( null );
	...
	public static void main(String[] args) {
		...
		//Instancia el panel
		EstructuraCola ventana = new  EstructuraCola(new Controlador1());
