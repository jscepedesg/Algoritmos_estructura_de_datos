...
public class EstructuraPila extends JFrame{
	
	private PanelIngreso2 pnlIngreso2;
	private PanelOpciones2 pnlOpciones2;
	private PanelInfo2 pnlInfo2;
	
	 Controlador2 ctrl2;

	public EstructuraPila(Controlador2 ctrl2)
	{
		...
		//Instaciar los paneles
		 pnlIngreso2 = new PanelIngreso2(ctrl2);
		 pnlOpciones2 = new PanelOpciones2(ctrl2);
		 pnlInfo2 = new PanelInfo2();
		 
		 getContentPane( ).add( pnlIngreso2 );
	     pnlIngreso2.setBounds( 10, 10, 230, 225 );
	     
	     getContentPane( ).add( pnlInfo2 );
	     pnlInfo2.setBounds( 255, 10, 230, 225 );
	     
	     getContentPane( ).add( pnlOpciones2 );
	     pnlOpciones2.setBounds( 10, 245, 475, 100 );
	     
	  // Conecta objetos a controlar
		  ctrl2.conectar2(pnlInfo2,pnlIngreso2);
	...
	public class PanelIngreso2 extends JPanel
	{
		...
		public PanelIngreso2(Controlador2 ctrl2)
		{
	...
	public class PanelOpciones2 extends JPanel implements ActionListener
	{
		private JButton opc[] = new JButton[4];
		private Controlador2 ctrl2;

		public PanelOpciones2(Controlador2 ctrl2)
		{
			setBorder(BorderFactory.createLineBorder(Color.RED.darker().darker()));
			setBackground(new Color(254,128,129));
			setLayout( null );
	...
	public class PanelInfo2 extends JPanel
	{
		...
		public void setElimina(String nom,String apel,String edad,String ced,String hora)
		{
			inf[8].setText(nom+", "+apel+", "+edad+", "+ced+", "+hora);
		}
	}
	...
	public static void main(String[] args) {
		...
		//Instancia el panel
		EstructuraPila ventana = new  EstructuraPila(new Controlador2());
